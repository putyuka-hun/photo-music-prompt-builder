(() => {
  ...
  const EN = {
    ...
    "Filmtípus": "Film stock", "Objektív": "Lens", "Képi stílus": "Visual style", "Lencse- és fényeffektusok": "Lens and light effects", "Opcionális · két legördülő mezőben legfeljebb két effektus kombinálható. A mintakép közelítő előnézetet mutat.": "Optional · combine up to two effects using the two dropdowns. The sample image shows an approximate preview.", "A kiválasztott filmtípus vizuális előnézete": "Visual preview of the selected film stock", "Filmtípus szerint színezett hegyvidéki referenciafotó": "Mountain reference photo graded to the selected film stock", "Előnézet": "Preview",
