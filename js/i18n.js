(() => {
  ...
  const EN = {
    ...
    "Mentett karakter kiválasztása": "Select saved character", "Még nincs mentett karakter": "No saved characters yet", "Eredeti arc prompt": "Original face prompt", "AI portré prompt": "AI portrait prompt", "Önálló AI portré prompt": "Standalone AI portrait prompt",
    ...
    "Filmtípus": "Film stock", "Objektív": "Lens", "Képi stílus": "Visual style", "A kiválasztott filmtípus vizuális előnézete": "Visual preview of the selected film stock", "Filmtípus szerint színezett hegyvidéki referenciafotó": "Mountain reference photo graded to the selected film stock", "Előnézet": "Preview",
    ...
    "Akvarell+vonal": "Watercolor + linework", "Barokk festmény": "Baroque painting", "Ceruza": "Pencil drawing", "Digitális festmény": "Digital painting", "Fotó-realisztikus B/W": "Photorealistic B&W", "Futurista": "Futuristic", "Impresszionizmus": "Impressionism", "Leonardo Davinci": "Leonardo da Vinci", "Linómetszet": "Linocut", "Minimalista": "Minimalist", "Olajfesték": "Oil painting", "Pasztell": "Pastel", "Rézkarc / metszet": "Etching / engraving", "Szénrajz": "Charcoal drawing", "Szürrealista": "Surrealist", "Tusrajz": "Ink drawing", "Vektor grafika": "Vector graphics", "Vízfesték": "Watercolor",
    ...
    "Nincs": "None", "Nincsenek emberek": "No people", "Egyedül": "Alone", "Egy személy": "One person", "Kis csoport": "Small group", "Közösség": "Community", "Tömeg": "Crowd", "Gyerekek is legyenek": "Include children", "Gyerekekkel": "With children",
  ...
  const translate = (value) => {
    ...
    const count = text.match(/^(\d+) szó(?: · (\d+) karakter)?$/);
    if (count) return `${count[1]} words${count[2] ? ` · ${count[2]} characters` : ""}`;
